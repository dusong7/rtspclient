...
JABBERD2_API void sha256_init(sha256_state_t *ctx);
JABBERD2_API void sha256_append(sha256_state_t *ctx, const unsigned char *dataIn, int len);
JABBERD2_API void sha256_finish(sha256_state_t *ctx, unsigned char hashout[SHA256_DIGEST_LENGTH]);
JABBERD2_API void sha256_hash(const unsigned char *dataIn, int len, unsigned char hashout[SHA256_DIGEST_LENGTH]);

JABBERD2_API void sha224_init(sha256_state_t *ctx);
JABBERD2_API void sha224_append(sha256_state_t *ctx, const unsigned char *dataIn, int len);
JABBERD2_API void sha224_finish(sha256_state_t *ctx, unsigned char hashout[SHA224_DIGEST_LENGTH]);
JABBERD2_API void sha224_hash(const unsigned char *dataIn, int len, unsigned char hashout[SHA224_DIGEST_LENGTH]);
