...
LPCSTR jabber_service_name = NULL;
LPCSTR jabber_service_display = NULL;
LPCSTR jabber_service_description = NULL;
LPCSTR jabber_service_depends = NULL;
jmainhandler_t *jabber_service_wrapper = NULL;

void WINAPI jabber_service_main(DWORD argc, LPSTR *argv);
...
int jabber_wrap_service(int argc, char** argv, jmainhandler_t *wrapper, LPCSTR name, LPCSTR display, LPCSTR description, LPCSTR depends)
{
    ...
    {
        CHAR szPathName[MAX_PATH]; LPSTR slash = NULL;
        SERVICE_TABLE_ENTRYA DispatchTable[] = {{(LPSTR)jabber_service_name, jabber_service_main}, {NULL, NULL}};
        ...
        {
            *slash = 0;
            SetCurrentDirectoryA(szPathName);
        }
...
void WINAPI jabber_service_main(DWORD argc, LPSTR *argv)
{
    ...
    jabber_service_status_handle = RegisterServiceCtrlHandlerA(jabber_service_name, jabber_service_ctrl_handler);
...
BOOL jabber_install_service()
{
    ...
    SERVICE_DESCRIPTIONA sdServiceDescription = { (LPSTR)jabber_service_description };
    ...
    ChangeServiceConfig2A(schService, SERVICE_CONFIG_DESCRIPTION, (LPVOID)&sdServiceDescription);
...
BOOL jabber_delete_service()
{
    ...
    hService=OpenServiceA(schSCManager, jabber_service_name, SERVICE_ALL_ACCESS);
