...
JABBERD2_API jid_t               jid_new_quick(const unsigned char *id, int len);
...
JABBERD2_API jid_t               jid_reset_quick(jid_t jid, const unsigned char *id, int len);
...
JABBERD2_API void                jid_shrink(jid_t jid);
#endif
